...
namespace Libreria_Personajes
{
    public class Personaje
    {
        ...
        public void Combatir(int agilidadDefensor, int resistenciaDefensor)
        {
            ...
            {
                Console.WriteLine("CRITICO 1 fase: ATAQUE. es ingolpeable ");
            ...
            {
                RecibirAtaques(resistenciaDefensor, rndAtaque);
            }
        }
        public void RecibirAtaques(int resistenciaDefensor,int rndAtaque)
        {           
                int rndGolpe = rng();
                ...
                if (AtacarSegundaFase(dañoRealizado))
                {
                    if (EsCritico(rndAtaque))
                    {
                        ...
                        dañoRealizado = golpe;
                        //si el rndha es critico no puede ser bloqueado
                    }
